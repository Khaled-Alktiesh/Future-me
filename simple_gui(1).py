...
class ChallengeScreen(QWidget):
    def __init__(self, back_function):
        ...
        # Display the challenge mode screen
        label = QLabel("Welcome to Challenge Mode!", self)
        label.setFont(QFont("Arial", 18))
        label.setAlignment(Qt.AlignCenter)

        challenge_description = QLabel("Complete your daily challenges and improve yourself.", self)
        ...
        layout.addWidget(label)
        layout.addWidget(challenge_description)
        layout.addWidget(back_button)
        self.setLayout(layout)
